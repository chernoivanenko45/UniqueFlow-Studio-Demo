...
Этот репозиторий содержит **ограниченную публичную Demo Edition** для сбора честных первых отзывов. Это не полная AI-версия. В демо намеренно отсутствуют рабочий Deep AI-backend, премиальные модели и исходный код.

## Как попробовать

1. Откройте раздел [Releases](https://github.com/chernoivanenko45/UniqueFlow-Studio-Demo/releases/latest).
2. Скачайте `UniqueFlowStudio_Demo_0.2.1_Portable.zip`.
...
> Не запускайте EXE прямо внутри WinRAR, 7-Zip или другого архиватора. Сначала полностью распакуйте всю папку: плееру нужны библиотеки, лежащие рядом с программой.
...
- Standard-монтаж с анализом ритма и движения
- Разные временные участки каждого выбранного ролика
- Свой трек или автоматический звук первого исходного видео
- Автоматический вертикальный или горизонтальный формат
- Нарезка, кадрирование, слоумо, реверс и визуальные акценты Standard
...
|---|---:|
| Standard-монтаж в ритм | Доступен |
...
Демо использует изолированный Standard-движок. Рабочий Deep AI-backend, AI-модели и премиальные модули физически отсутствуют в скачиваемой сборке.
